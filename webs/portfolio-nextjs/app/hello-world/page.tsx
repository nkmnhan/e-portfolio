...
import { textPrimary, textSecondary, textMuted, textWhite } from "@/app/components/themes/default-text";
import { FaGithub, FaReact, FaNodeJs, FaDocker, FaAws, FaFigma, FaGitAlt } from "react-icons/fa";
...
const TECHNOLOGIES = [
  ...
  { icon: SiTailwindcss, name: "Tailwind CSS", desc: "Utility-first CSS framework" },
...
const TODO_ACTIONS = [
  ...
  { action: "Add project case studies with detailed breakdowns", priority: "Medium" },
  ...
  { action: "Implement PWA features for mobile app experience", priority: "Low" },
];
    ...
    <div className="fixed inset-0 overflow-y-auto hide-scrollbar">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className={clsxMerge("text-4xl md:text-6xl font-bold mb-4", textWhite)}>
            Portfolio Behind the Scenes
          </h1>
          <p className={clsxMerge("text-lg md:text-xl max-w-2xl mx-auto", textWhite)}>
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 rounded-2xl p-8 md:p-12">
            <p className={clsxMerge("text-base md:text-lg leading-relaxed", textWhite)}>
              This portfolio serves as a showcase of my skills in modern web development, demonstrating proficiency in Next.js, TypeScript, and responsive design.
              It was created to attract potential clients and employers while providing an interactive experience that reflects my passion for clean, efficient code and beautiful user interfaces.
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {TECHNOLOGIES.map((tech, idx) => (
              <div key={idx} className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
                ...
                <h3 className={clsxMerge("font-semibold mb-2", textPrimary)}>{tech.name}</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {TOOLS.map((tool, idx) => (
              <div key={idx} className="bg-gradient-to-br from-green-50 to-teal-50 dark:from-green-900/30 dark:to-teal-900/30 rounded-xl p-6 text-center hover:shadow-lg transition-shadow">
                ...
                <h3 className={clsxMerge("font-semibold mb-2", textPrimary)}>{tool.name}</h3>
        ...
        <section className="mb-16">
          ...
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:from-purple-500/20 dark:to-pink-500/20 rounded-2xl p-8 md:p-12">
            ...
            <h3 className={clsxMerge("text-xl font-semibold mb-4 text-center", textWhite)}>Automated Deployment</h3>
            <p className={clsxMerge("text-base md:text-lg leading-relaxed text-center", textWhite)}>
              This portfolio is deployed using Vercel's platform, which provides automatic deployments from GitHub,
              preview deployments for pull requests, and global CDN for optimal performance. The CI/CD pipeline
              ensures that every code change is automatically tested and deployed.
            </p>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {TODO_ACTIONS.map((todo, idx) => (
              <div key={idx} className="bg-gradient-to-r from-orange-500/10 to-red-500/10 dark:from-orange-500/20 dark:to-red-500/20 rounded-xl p-6 border-l-4 border-orange-500">
                ...
                <p className={clsxMerge("text-base", textWhite)}>{todo.action}</p>
              </div>
            ))}
          </div>
        </section>
