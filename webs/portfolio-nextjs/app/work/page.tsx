...
const STYLES = {
  ...
  profileSection:
    "flex flex-col md:flex-row items-center gap-6 md:gap-8 mb-12 p-8 md:p-10 rounded-2xl bg-linear-to-r from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20 border-2 border-blue-500/30 dark:border-blue-400/40 shadow-xl",
  avatar:
    "w-28 h-28 md:w-36 md:h-36 rounded-full border-4 border-blue-500 dark:border-blue-400 shadow-2xl",
  ...
  statCard:
    "text-center p-4 md:p-6 rounded-xl bg-gradient-to-br shadow-lg hover:shadow-xl transition-all duration-300",
  statValue: "text-3xl md:text-4xl font-bold mb-1",
  statLabel: "text-sm md:text-base opacity-90",
  tabWrapper: "mb-8",
  tabContent: "h-full mb-12",
  categoryHeader:
    "mb-8 p-6 md:p-8 rounded-xl bg-linear-to-r from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 border border-blue-200 dark:border-blue-800",
