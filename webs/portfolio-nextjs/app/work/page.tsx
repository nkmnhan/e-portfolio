...
const tabContentWrapper =
  "max-h-[320px] md:max-h-[640px] overflow-y-auto pr-2 hide-scrollbar";
...
export default function Work() {
  ...
  useEffect(() => {
    setHeights(IMAGE_URLS.map(() => 320 + Math.floor(Math.random() * 48) * 4));
  }, []);
    ...
    <div className={clsxMerge("fixed inset-0", pagePadding, bgPrimary)}>
      <Tabs aria-label="Default tabs" variant="default" className="mx-auto">
        ...
        <TabItem title="Dashboard" icon={MdDashboard}>
          This is{" "}
          <span className={tabText}>Dashboard tab's associated content</span>.
        ...
        <TabItem title="Settings" icon={HiAdjustments}>
          This is{" "}
          <span className={tabText}>Settings tab's associated content</span>.
          Clicking another tab will toggle the visibility of this one for the
          next. The tab JavaScript swaps classes to control the content
          visibility and styling.
        </TabItem>
        <TabItem title="Contacts" icon={HiClipboardList}>
          This is{" "}
          <span className={tabText}>Contacts tab's associated content</span>.
          Clicking another tab will toggle the visibility of this one for the
          next. The tab JavaScript swaps classes to control the content
          visibility and styling.
        </TabItem>
