...
const STYLES = {
  ...
  contentWrapper: "max-w-7xl mx-auto px-6 md:px-12 py-12",
  ...
  statsGrid: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-12",
  statCard: "text-center p-6 rounded-xl bg-gradient-to-br shadow-lg hover:shadow-xl transition-all duration-300",
