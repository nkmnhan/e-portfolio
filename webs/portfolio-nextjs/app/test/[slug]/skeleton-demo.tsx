...
export default function SkeletonDemo() {
  return (
    <div className="space-y-12">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Image Placeholder</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Video Placeholder</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <VideoPlaceholder />
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Testimonial Placeholder</h2>
        <div className="space-y-6">
