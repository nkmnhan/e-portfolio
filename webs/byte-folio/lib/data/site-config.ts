...
export const siteConfig: SiteConfig = {
  name: "Tony Nguyen",
  title: "nkmnhan — Tony Nguyen | Senior Fullstack Developer | .NET, React, Cloud",
  description:
    "nkmnhan — Senior Fullstack Developer with 9+ years in .NET, React & cloud-native systems. Explore projects, skills and experience by Tony Nguyen (Nhan Nguyen).",
